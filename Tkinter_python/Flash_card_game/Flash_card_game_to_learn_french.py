...
def wrong_click():
    img1 = PhotoImage(file='D:\\ADITYA IMPORTANT PDF\\Codes\\python\\Tkinter_python\\Flash_card_game\\images\\card_back.png')
...
try : 
    data = pd.read_csv("D:\\ADITYA IMPORTANT PDF\\Codes\\python\\Tkinter_python\\Flash_card_game\\data/french_words.csv")
...
img = PhotoImage(file="D:\\ADITYA IMPORTANT PDF\\Codes\\python\\Tkinter_python\\Flash_card_game\\images\\card_front.png")
